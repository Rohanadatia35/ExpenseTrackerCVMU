...
export const setting =<i class="fa-solid fa-gear"></i>
export const setlimit = <i className="fa-solid fa-chart-line"></i>
export const update =<i class="fa-solid fa-arrows-spin"></i>